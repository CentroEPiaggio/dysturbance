...
Pendulum_lenght = str2double(data_structure.lenght);
...
Bar_mass = 4.13 * (Pendulum_lenght - Joint_distance) + Joint_mass;

Pendulum_mass = Bar_mass + Pendulum__added_mass;

%store pendulum data in a vector
Pendulum_data = [Pendulum_lenght, Pendulum_height, Pendulum_mass];
