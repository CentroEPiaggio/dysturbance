function [Equivalent_impedance] = Excited_equivalent_impedance(datafile, Pendulum_data)
%--------------------------------------------------------------------------
...
Data_local_impedance_folder = Data_folder;
Impedance_file_name = strcat('Equivalent_impedance_',datafile);
