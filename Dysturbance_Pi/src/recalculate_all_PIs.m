function recalculate_all_PIs(data_folder,Protocol, result_folder)
...
Global_PI_folder = fullfile(result_folder, data_folder,Protocol_folder,'Global_PIs');
status = rmdir(Global_PI_folder,'s');

Experiment_folder = fullfile(result_folder, data_folder,Protocol_folder);
...
%     
%     for i = 1:num_folder
%         Preprocessed_folder = fullfile(Tests_folders(i),'Preprocessed_data');
